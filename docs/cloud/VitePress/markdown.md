...
# VitePress Markdown 语法

::: info
From：[官方文档 - Markdown 扩展](https://vitepress.dev/zh/guide/markdown)
:::
...
略，详见：[Markdown 扩展 - 导入代码片段](https://vitepress.dev/zh/guide/markdown#import-code-snippets)
...
略，详见：[Markdown 扩展 - 代码组-导入代码片段](https://vitepress.dev/zh/guide/markdown#import-code-snippets)

## 包含 markdown 文件 {#markdown-file-inclusion}

略，详见：[Markdown 扩展 - 包含 markdown 文件](https://vitepress.dev/zh/guide/markdown#markdown-file-inclusion)
